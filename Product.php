	...
	<div class="container">
	  	...
	  	<form action="#" method="POST" onsubmit="return validate()">
		    <div class="form-group">
		      ...
		      <input type="text" class="form-control" id="name" name="name" > <span id="pname"></span>
		    </div>
		    <div class="form-group">
		      <label for="description">Product Description:</label>
		      <textarea class="form-control" id="description" name="description" rows="5" ></textarea><span id="pdesc"></span>
		    </div>
		    <div class="form-group">
		      <label for="company">Product Company:</label>
		      <input type="text" class="form-control" id="company" name="company" ></input><span id="pcompany"></span>
		    </div>
		    <div class="form-group">
		      <label for="price">Price:</label>
		      <input type="number" class="form-control" id="price" name="price" ><span id="pamount"></span>
		    </div>
		    <div class="form-group">
	...
	<div class="container">
		...
		<div class="card">
			...
			<div class="card-body">
				<div class="row">
					<div class="col-md-6">
						<img src="lp1.jpg" alt="Dell XPS 15" class="product-img">
					</div>
				...
				<div class="row">
					<div class="col-md-6">
						<img src="lp2.jpg" alt="Dell XPS 15" class="product-img">
					</div>
					<div class="col-md-6 product-info">
						<h2>Dell XPS 15</h2>
						<p>15.6-inch laptop with a stunning 4K OLED display.</p>
				...
				<div class="row">
					<div class="col-md-6">
						<img src="lp3.jpg" alt="Dell XPS 15" class="product-img">
					</div>
					<div class="col-md-6 product-info">
						<h2>Dell XPS 15</h2>
						<p>15.6-inch laptop with a stunning 4K OLED display.</p>
				...
				<div class="row">
					<div class="col-md-6">
						<img src="dell2.jpg" alt="Dell XPS 15" class="product-img">
					</div>
					<div class="col-md-6 product-info">
						<h2>Dell XPS 15</h2>
						<p>15.6-inch laptop with a stunning 4K OLED display.</p>
				...
				<div class="row">
					<div class="col-md-6">
						<img src="macbook.jpg" alt="Dell XPS 15" class="product-img">
					</div>
					<div class="col-md-6 product-info">
						<h2>Dell XPS 15</h2>
						<p>15.6-inch laptop with a stunning 4K OLED display.</p>
